...
int main()
{
	...
	*/
	IrrlichtDevice *device =
		createDevice( video::EDT_SOFTWARE, dimension2d<u32>(1440, 900), 32,
			1, 1, false, 0);
	...
	*/
	while (device->run())
	{
		...
		*/
		//const SExposedVideoData& videoData = video::SExposedVideoData();
		//rect<irr::s32>* myRect = new rect<irr::s32>(0, 0, 2500, 2000);
		//driver->beginScene(true, true, SColor(255,100,101,140),videoData,myRect);
